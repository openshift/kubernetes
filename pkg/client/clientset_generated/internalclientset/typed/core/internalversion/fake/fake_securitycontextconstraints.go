...
var securitycontextconstraintsKind = schema.GroupVersionKind{Group: "", Version: "", Kind: "SecurityContextConstraints"}
...
func (c *FakeSecurityContextConstraints) List(opts v1.ListOptions) (result *api.SecurityContextConstraintsList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootListAction(securitycontextconstraintsResource, securitycontextconstraintsKind, opts), &api.SecurityContextConstraintsList{})
	if obj == nil {
		return nil, err
	}
