...
func RegisterConversions(scheme *runtime.Scheme) error {
	return scheme.AddGeneratedConversionFuncs(
		...
		Convert_v1beta1_IDRange_To_api_IDRange,
		Convert_api_IDRange_To_v1beta1_IDRange,
...
func autoConvert_v1beta1_IDRange_To_api_IDRange(in *IDRange, out *api.IDRange, s conversion.Scope) error {
	out.Min = in.Min
	out.Max = in.Max
	return nil
}

// Convert_v1beta1_IDRange_To_api_IDRange is an autogenerated conversion function.
func Convert_v1beta1_IDRange_To_api_IDRange(in *IDRange, out *api.IDRange, s conversion.Scope) error {
	return autoConvert_v1beta1_IDRange_To_api_IDRange(in, out, s)
}

func autoConvert_api_IDRange_To_v1beta1_IDRange(in *api.IDRange, out *IDRange, s conversion.Scope) error {
	out.Min = in.Min
	out.Max = in.Max
	return nil
}

// Convert_api_IDRange_To_v1beta1_IDRange is an autogenerated conversion function.
func Convert_api_IDRange_To_v1beta1_IDRange(in *api.IDRange, out *IDRange, s conversion.Scope) error {
	return autoConvert_api_IDRange_To_v1beta1_IDRange(in, out, s)
}
