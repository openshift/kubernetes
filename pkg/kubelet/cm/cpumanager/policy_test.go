...
var (
	...
	*/
	topoDualSocketSingleNumaPerSocketHTLargeCacheGroups = &topology.CPUTopology{
		NumCPUs:         384,
		NumSockets:      2,
		NumCores:        192,
		NumNUMANodes:    2,
		...
		CPUDetails: map[int]topology.CPUInfo{
			...
			8:   {CoreID: 8, SocketID: 0, NUMANodeID: 0, UnCoreCacheID: 4},
			9:   {CoreID: 9, SocketID: 0, NUMANodeID: 0, UnCoreCacheID: 4},
			10:  {CoreID: 10, SocketID: 0, NUMANodeID: 0, UnCoreCacheID: 4},
			11:  {CoreID: 11, SocketID: 0, NUMANodeID: 0, UnCoreCacheID: 4},
			12:  {CoreID: 12, SocketID: 0, NUMANodeID: 0, UnCoreCacheID: 4},
			13:  {CoreID: 13, SocketID: 0, NUMANodeID: 0, UnCoreCacheID: 4},
			14:  {CoreID: 14, SocketID: 0, NUMANodeID: 0, UnCoreCacheID: 4},
			15:  {CoreID: 15, SocketID: 0, NUMANodeID: 0, UnCoreCacheID: 4},
			16:  {CoreID: 16, SocketID: 0, NUMANodeID: 0, UnCoreCacheID: 8},
			17:  {CoreID: 17, SocketID: 0, NUMANodeID: 0, UnCoreCacheID: 8},
			18:  {CoreID: 18, SocketID: 0, NUMANodeID: 0, UnCoreCacheID: 8},
			19:  {CoreID: 19, SocketID: 0, NUMANodeID: 0, UnCoreCacheID: 8},
			20:  {CoreID: 20, SocketID: 0, NUMANodeID: 0, UnCoreCacheID: 8},
			21:  {CoreID: 21, SocketID: 0, NUMANodeID: 0, UnCoreCacheID: 8},
			22:  {CoreID: 22, SocketID: 0, NUMANodeID: 0, UnCoreCacheID: 8},
			23:  {CoreID: 23, SocketID: 0, NUMANodeID: 0, UnCoreCacheID: 8},
			24:  {CoreID: 24, SocketID: 0, NUMANodeID: 0, UnCoreCacheID: 2},
			25:  {CoreID: 25, SocketID: 0, NUMANodeID: 0, UnCoreCacheID: 2},
			26:  {CoreID: 26, SocketID: 0, NUMANodeID: 0, UnCoreCacheID: 2},
			27:  {CoreID: 27, SocketID: 0, NUMANodeID: 0, UnCoreCacheID: 2},
			28:  {CoreID: 28, SocketID: 0, NUMANodeID: 0, UnCoreCacheID: 2},
			29:  {CoreID: 29, SocketID: 0, NUMANodeID: 0, UnCoreCacheID: 2},
			30:  {CoreID: 30, SocketID: 0, NUMANodeID: 0, UnCoreCacheID: 2},
			31:  {CoreID: 31, SocketID: 0, NUMANodeID: 0, UnCoreCacheID: 2},
			32:  {CoreID: 32, SocketID: 0, NUMANodeID: 0, UnCoreCacheID: 6},
			33:  {CoreID: 33, SocketID: 0, NUMANodeID: 0, UnCoreCacheID: 6},
			34:  {CoreID: 34, SocketID: 0, NUMANodeID: 0, UnCoreCacheID: 6},
			35:  {CoreID: 35, SocketID: 0, NUMANodeID: 0, UnCoreCacheID: 6},
			36:  {CoreID: 36, SocketID: 0, NUMANodeID: 0, UnCoreCacheID: 6},
			37:  {CoreID: 37, SocketID: 0, NUMANodeID: 0, UnCoreCacheID: 6},
			38:  {CoreID: 38, SocketID: 0, NUMANodeID: 0, UnCoreCacheID: 6},
			39:  {CoreID: 39, SocketID: 0, NUMANodeID: 0, UnCoreCacheID: 6},
			40:  {CoreID: 40, SocketID: 0, NUMANodeID: 0, UnCoreCacheID: 10},
			41:  {CoreID: 41, SocketID: 0, NUMANodeID: 0, UnCoreCacheID: 10},
			42:  {CoreID: 42, SocketID: 0, NUMANodeID: 0, UnCoreCacheID: 10},
			43:  {CoreID: 43, SocketID: 0, NUMANodeID: 0, UnCoreCacheID: 10},
			44:  {CoreID: 44, SocketID: 0, NUMANodeID: 0, UnCoreCacheID: 10},
			45:  {CoreID: 45, SocketID: 0, NUMANodeID: 0, UnCoreCacheID: 10},
			46:  {CoreID: 46, SocketID: 0, NUMANodeID: 0, UnCoreCacheID: 10},
			47:  {CoreID: 47, SocketID: 0, NUMANodeID: 0, UnCoreCacheID: 10},
			48:  {CoreID: 48, SocketID: 0, NUMANodeID: 0, UnCoreCacheID: 3},
			49:  {CoreID: 49, SocketID: 0, NUMANodeID: 0, UnCoreCacheID: 3},
			50:  {CoreID: 50, SocketID: 0, NUMANodeID: 0, UnCoreCacheID: 3},
			51:  {CoreID: 51, SocketID: 0, NUMANodeID: 0, UnCoreCacheID: 3},
			52:  {CoreID: 52, SocketID: 0, NUMANodeID: 0, UnCoreCacheID: 3},
			53:  {CoreID: 53, SocketID: 0, NUMANodeID: 0, UnCoreCacheID: 3},
			54:  {CoreID: 54, SocketID: 0, NUMANodeID: 0, UnCoreCacheID: 3},
			55:  {CoreID: 55, SocketID: 0, NUMANodeID: 0, UnCoreCacheID: 3},
			56:  {CoreID: 56, SocketID: 0, NUMANodeID: 0, UnCoreCacheID: 7},
			57:  {CoreID: 57, SocketID: 0, NUMANodeID: 0, UnCoreCacheID: 7},
			58:  {CoreID: 58, SocketID: 0, NUMANodeID: 0, UnCoreCacheID: 7},
			59:  {CoreID: 59, SocketID: 0, NUMANodeID: 0, UnCoreCacheID: 7},
			60:  {CoreID: 60, SocketID: 0, NUMANodeID: 0, UnCoreCacheID: 7},
			61:  {CoreID: 61, SocketID: 0, NUMANodeID: 0, UnCoreCacheID: 7},
			62:  {CoreID: 62, SocketID: 0, NUMANodeID: 0, UnCoreCacheID: 7},
			63:  {CoreID: 63, SocketID: 0, NUMANodeID: 0, UnCoreCacheID: 7},
			64:  {CoreID: 64, SocketID: 0, NUMANodeID: 0, UnCoreCacheID: 11},
			65:  {CoreID: 65, SocketID: 0, NUMANodeID: 0, UnCoreCacheID: 11},
			66:  {CoreID: 66, SocketID: 0, NUMANodeID: 0, UnCoreCacheID: 11},
			67:  {CoreID: 67, SocketID: 0, NUMANodeID: 0, UnCoreCacheID: 11},
			68:  {CoreID: 68, SocketID: 0, NUMANodeID: 0, UnCoreCacheID: 11},
			69:  {CoreID: 69, SocketID: 0, NUMANodeID: 0, UnCoreCacheID: 11},
			70:  {CoreID: 70, SocketID: 0, NUMANodeID: 0, UnCoreCacheID: 11},
			71:  {CoreID: 71, SocketID: 0, NUMANodeID: 0, UnCoreCacheID: 11},
			72:  {CoreID: 72, SocketID: 0, NUMANodeID: 0, UnCoreCacheID: 1},
			73:  {CoreID: 73, SocketID: 0, NUMANodeID: 0, UnCoreCacheID: 1},
			74:  {CoreID: 74, SocketID: 0, NUMANodeID: 0, UnCoreCacheID: 1},
			75:  {CoreID: 75, SocketID: 0, NUMANodeID: 0, UnCoreCacheID: 1},
			76:  {CoreID: 76, SocketID: 0, NUMANodeID: 0, UnCoreCacheID: 1},
			77:  {CoreID: 77, SocketID: 0, NUMANodeID: 0, UnCoreCacheID: 1},
			78:  {CoreID: 78, SocketID: 0, NUMANodeID: 0, UnCoreCacheID: 1},
			79:  {CoreID: 79, SocketID: 0, NUMANodeID: 0, UnCoreCacheID: 1},
			80:  {CoreID: 80, SocketID: 0, NUMANodeID: 0, UnCoreCacheID: 5},
			81:  {CoreID: 81, SocketID: 0, NUMANodeID: 0, UnCoreCacheID: 5},
			82:  {CoreID: 82, SocketID: 0, NUMANodeID: 0, UnCoreCacheID: 5},
			83:  {CoreID: 83, SocketID: 0, NUMANodeID: 0, UnCoreCacheID: 5},
			84:  {CoreID: 84, SocketID: 0, NUMANodeID: 0, UnCoreCacheID: 5},
			85:  {CoreID: 85, SocketID: 0, NUMANodeID: 0, UnCoreCacheID: 5},
			86:  {CoreID: 86, SocketID: 0, NUMANodeID: 0, UnCoreCacheID: 5},
			87:  {CoreID: 87, SocketID: 0, NUMANodeID: 0, UnCoreCacheID: 5},
			88:  {CoreID: 88, SocketID: 0, NUMANodeID: 0, UnCoreCacheID: 9},
			89:  {CoreID: 89, SocketID: 0, NUMANodeID: 0, UnCoreCacheID: 9},
			90:  {CoreID: 90, SocketID: 0, NUMANodeID: 0, UnCoreCacheID: 9},
			91:  {CoreID: 91, SocketID: 0, NUMANodeID: 0, UnCoreCacheID: 9},
			92:  {CoreID: 92, SocketID: 0, NUMANodeID: 0, UnCoreCacheID: 9},
			93:  {CoreID: 93, SocketID: 0, NUMANodeID: 0, UnCoreCacheID: 9},
			94:  {CoreID: 94, SocketID: 0, NUMANodeID: 0, UnCoreCacheID: 9},
			95:  {CoreID: 95, SocketID: 0, NUMANodeID: 0, UnCoreCacheID: 9},
			96:  {CoreID: 96, SocketID: 1, NUMANodeID: 1, UnCoreCacheID: 16},
			97:  {CoreID: 97, SocketID: 1, NUMANodeID: 1, UnCoreCacheID: 16},
			98:  {CoreID: 98, SocketID: 1, NUMANodeID: 1, UnCoreCacheID: 16},
			99:  {CoreID: 99, SocketID: 1, NUMANodeID: 1, UnCoreCacheID: 16},
			100: {CoreID: 100, SocketID: 1, NUMANodeID: 1, UnCoreCacheID: 16},
			101: {CoreID: 101, SocketID: 1, NUMANodeID: 1, UnCoreCacheID: 16},
			102: {CoreID: 102, SocketID: 1, NUMANodeID: 1, UnCoreCacheID: 16},
			103: {CoreID: 103, SocketID: 1, NUMANodeID: 1, UnCoreCacheID: 16},
			104: {CoreID: 104, SocketID: 1, NUMANodeID: 1, UnCoreCacheID: 20},
			105: {CoreID: 105, SocketID: 1, NUMANodeID: 1, UnCoreCacheID: 20},
			106: {CoreID: 106, SocketID: 1, NUMANodeID: 1, UnCoreCacheID: 20},
			107: {CoreID: 107, SocketID: 1, NUMANodeID: 1, UnCoreCacheID: 20},
			108: {CoreID: 108, SocketID: 1, NUMANodeID: 1, UnCoreCacheID: 20},
			109: {CoreID: 109, SocketID: 1, NUMANodeID: 1, UnCoreCacheID: 20},
			110: {CoreID: 110, SocketID: 1, NUMANodeID: 1, UnCoreCacheID: 20},
			111: {CoreID: 111, SocketID: 1, NUMANodeID: 1, UnCoreCacheID: 20},
			112: {CoreID: 112, SocketID: 1, NUMANodeID: 1, UnCoreCacheID: 24},
			113: {CoreID: 113, SocketID: 1, NUMANodeID: 1, UnCoreCacheID: 24},
			114: {CoreID: 114, SocketID: 1, NUMANodeID: 1, UnCoreCacheID: 24},
			115: {CoreID: 115, SocketID: 1, NUMANodeID: 1, UnCoreCacheID: 24},
			116: {CoreID: 116, SocketID: 1, NUMANodeID: 1, UnCoreCacheID: 24},
			117: {CoreID: 117, SocketID: 1, NUMANodeID: 1, UnCoreCacheID: 24},
			118: {CoreID: 118, SocketID: 1, NUMANodeID: 1, UnCoreCacheID: 24},
			119: {CoreID: 119, SocketID: 1, NUMANodeID: 1, UnCoreCacheID: 24},
			120: {CoreID: 120, SocketID: 1, NUMANodeID: 1, UnCoreCacheID: 18},
			121: {CoreID: 121, SocketID: 1, NUMANodeID: 1, UnCoreCacheID: 18},
			122: {CoreID: 122, SocketID: 1, NUMANodeID: 1, UnCoreCacheID: 18},
			123: {CoreID: 123, SocketID: 1, NUMANodeID: 1, UnCoreCacheID: 18},
			124: {CoreID: 124, SocketID: 1, NUMANodeID: 1, UnCoreCacheID: 18},
			125: {CoreID: 125, SocketID: 1, NUMANodeID: 1, UnCoreCacheID: 18},
			126: {CoreID: 126, SocketID: 1, NUMANodeID: 1, UnCoreCacheID: 18},
			127: {CoreID: 127, SocketID: 1, NUMANodeID: 1, UnCoreCacheID: 18},
			128: {CoreID: 128, SocketID: 1, NUMANodeID: 1, UnCoreCacheID: 22},
			129: {CoreID: 129, SocketID: 1, NUMANodeID: 1, UnCoreCacheID: 22},
			130: {CoreID: 130, SocketID: 1, NUMANodeID: 1, UnCoreCacheID: 22},
			131: {CoreID: 131, SocketID: 1, NUMANodeID: 1, UnCoreCacheID: 22},
			132: {CoreID: 132, SocketID: 1, NUMANodeID: 1, UnCoreCacheID: 22},
			133: {CoreID: 133, SocketID: 1, NUMANodeID: 1, UnCoreCacheID: 22},
			134: {CoreID: 134, SocketID: 1, NUMANodeID: 1, UnCoreCacheID: 22},
			135: {CoreID: 135, SocketID: 1, NUMANodeID: 1, UnCoreCacheID: 22},
			136: {CoreID: 136, SocketID: 1, NUMANodeID: 1, UnCoreCacheID: 26},
			137: {CoreID: 137, SocketID: 1, NUMANodeID: 1, UnCoreCacheID: 26},
			138: {CoreID: 138, SocketID: 1, NUMANodeID: 1, UnCoreCacheID: 26},
			139: {CoreID: 139, SocketID: 1, NUMANodeID: 1, UnCoreCacheID: 26},
			140: {CoreID: 140, SocketID: 1, NUMANodeID: 1, UnCoreCacheID: 26},
			141: {CoreID: 141, SocketID: 1, NUMANodeID: 1, UnCoreCacheID: 26},
			142: {CoreID: 142, SocketID: 1, NUMANodeID: 1, UnCoreCacheID: 26},
			143: {CoreID: 143, SocketID: 1, NUMANodeID: 1, UnCoreCacheID: 26},
			144: {CoreID: 144, SocketID: 1, NUMANodeID: 1, UnCoreCacheID: 19},
			145: {CoreID: 145, SocketID: 1, NUMANodeID: 1, UnCoreCacheID: 19},
			146: {CoreID: 146, SocketID: 1, NUMANodeID: 1, UnCoreCacheID: 19},
			147: {CoreID: 147, SocketID: 1, NUMANodeID: 1, UnCoreCacheID: 19},
			148: {CoreID: 148, SocketID: 1, NUMANodeID: 1, UnCoreCacheID: 19},
			149: {CoreID: 149, SocketID: 1, NUMANodeID: 1, UnCoreCacheID: 19},
			150: {CoreID: 150, SocketID: 1, NUMANodeID: 1, UnCoreCacheID: 19},
			151: {CoreID: 151, SocketID: 1, NUMANodeID: 1, UnCoreCacheID: 19},
			152: {CoreID: 152, SocketID: 1, NUMANodeID: 1, UnCoreCacheID: 23},
			153: {CoreID: 153, SocketID: 1, NUMANodeID: 1, UnCoreCacheID: 23},
			154: {CoreID: 154, SocketID: 1, NUMANodeID: 1, UnCoreCacheID: 23},
			155: {CoreID: 155, SocketID: 1, NUMANodeID: 1, UnCoreCacheID: 23},
			156: {CoreID: 156, SocketID: 1, NUMANodeID: 1, UnCoreCacheID: 23},
			157: {CoreID: 157, SocketID: 1, NUMANodeID: 1, UnCoreCacheID: 23},
			158: {CoreID: 158, SocketID: 1, NUMANodeID: 1, UnCoreCacheID: 23},
			159: {CoreID: 159, SocketID: 1, NUMANodeID: 1, UnCoreCacheID: 23},
			160: {CoreID: 160, SocketID: 1, NUMANodeID: 1, UnCoreCacheID: 27},
			161: {CoreID: 161, SocketID: 1, NUMANodeID: 1, UnCoreCacheID: 27},
			162: {CoreID: 162, SocketID: 1, NUMANodeID: 1, UnCoreCacheID: 27},
			163: {CoreID: 163, SocketID: 1, NUMANodeID: 1, UnCoreCacheID: 27},
			164: {CoreID: 164, SocketID: 1, NUMANodeID: 1, UnCoreCacheID: 27},
			165: {CoreID: 165, SocketID: 1, NUMANodeID: 1, UnCoreCacheID: 27},
			166: {CoreID: 166, SocketID: 1, NUMANodeID: 1, UnCoreCacheID: 27},
			167: {CoreID: 167, SocketID: 1, NUMANodeID: 1, UnCoreCacheID: 27},
			168: {CoreID: 168, SocketID: 1, NUMANodeID: 1, UnCoreCacheID: 17},
			169: {CoreID: 169, SocketID: 1, NUMANodeID: 1, UnCoreCacheID: 17},
			170: {CoreID: 170, SocketID: 1, NUMANodeID: 1, UnCoreCacheID: 17},
			171: {CoreID: 171, SocketID: 1, NUMANodeID: 1, UnCoreCacheID: 17},
			172: {CoreID: 172, SocketID: 1, NUMANodeID: 1, UnCoreCacheID: 17},
			173: {CoreID: 173, SocketID: 1, NUMANodeID: 1, UnCoreCacheID: 17},
			174: {CoreID: 174, SocketID: 1, NUMANodeID: 1, UnCoreCacheID: 17},
			175: {CoreID: 175, SocketID: 1, NUMANodeID: 1, UnCoreCacheID: 17},
			176: {CoreID: 176, SocketID: 1, NUMANodeID: 1, UnCoreCacheID: 21},
			177: {CoreID: 177, SocketID: 1, NUMANodeID: 1, UnCoreCacheID: 21},
			178: {CoreID: 178, SocketID: 1, NUMANodeID: 1, UnCoreCacheID: 21},
			179: {CoreID: 179, SocketID: 1, NUMANodeID: 1, UnCoreCacheID: 21},
			180: {CoreID: 180, SocketID: 1, NUMANodeID: 1, UnCoreCacheID: 21},
			181: {CoreID: 181, SocketID: 1, NUMANodeID: 1, UnCoreCacheID: 21},
			182: {CoreID: 182, SocketID: 1, NUMANodeID: 1, UnCoreCacheID: 21},
			183: {CoreID: 183, SocketID: 1, NUMANodeID: 1, UnCoreCacheID: 21},
			184: {CoreID: 184, SocketID: 1, NUMANodeID: 1, UnCoreCacheID: 25},
			185: {CoreID: 185, SocketID: 1, NUMANodeID: 1, UnCoreCacheID: 25},
			186: {CoreID: 186, SocketID: 1, NUMANodeID: 1, UnCoreCacheID: 25},
			187: {CoreID: 187, SocketID: 1, NUMANodeID: 1, UnCoreCacheID: 25},
			188: {CoreID: 188, SocketID: 1, NUMANodeID: 1, UnCoreCacheID: 25},
			189: {CoreID: 189, SocketID: 1, NUMANodeID: 1, UnCoreCacheID: 25},
			190: {CoreID: 190, SocketID: 1, NUMANodeID: 1, UnCoreCacheID: 25},
			191: {CoreID: 191, SocketID: 1, NUMANodeID: 1, UnCoreCacheID: 25},
			192: {CoreID: 0, SocketID: 0, NUMANodeID: 0, UnCoreCacheID: 0},
			193: {CoreID: 1, SocketID: 0, NUMANodeID: 0, UnCoreCacheID: 0},
			194: {CoreID: 2, SocketID: 0, NUMANodeID: 0, UnCoreCacheID: 0},
			195: {CoreID: 3, SocketID: 0, NUMANodeID: 0, UnCoreCacheID: 0},
			196: {CoreID: 4, SocketID: 0, NUMANodeID: 0, UnCoreCacheID: 0},
			197: {CoreID: 5, SocketID: 0, NUMANodeID: 0, UnCoreCacheID: 0},
			198: {CoreID: 6, SocketID: 0, NUMANodeID: 0, UnCoreCacheID: 0},
			199: {CoreID: 7, SocketID: 0, NUMANodeID: 0, UnCoreCacheID: 0},
			200: {CoreID: 8, SocketID: 0, NUMANodeID: 0, UnCoreCacheID: 4},
			201: {CoreID: 9, SocketID: 0, NUMANodeID: 0, UnCoreCacheID: 4},
			202: {CoreID: 10, SocketID: 0, NUMANodeID: 0, UnCoreCacheID: 4},
			203: {CoreID: 11, SocketID: 0, NUMANodeID: 0, UnCoreCacheID: 4},
			204: {CoreID: 12, SocketID: 0, NUMANodeID: 0, UnCoreCacheID: 4},
			205: {CoreID: 13, SocketID: 0, NUMANodeID: 0, UnCoreCacheID: 4},
			206: {CoreID: 14, SocketID: 0, NUMANodeID: 0, UnCoreCacheID: 4},
			207: {CoreID: 15, SocketID: 0, NUMANodeID: 0, UnCoreCacheID: 4},
			208: {CoreID: 16, SocketID: 0, NUMANodeID: 0, UnCoreCacheID: 8},
			209: {CoreID: 17, SocketID: 0, NUMANodeID: 0, UnCoreCacheID: 8},
			210: {CoreID: 18, SocketID: 0, NUMANodeID: 0, UnCoreCacheID: 8},
			211: {CoreID: 19, SocketID: 0, NUMANodeID: 0, UnCoreCacheID: 8},
			212: {CoreID: 20, SocketID: 0, NUMANodeID: 0, UnCoreCacheID: 8},
			213: {CoreID: 21, SocketID: 0, NUMANodeID: 0, UnCoreCacheID: 8},
			214: {CoreID: 22, SocketID: 0, NUMANodeID: 0, UnCoreCacheID: 8},
			215: {CoreID: 23, SocketID: 0, NUMANodeID: 0, UnCoreCacheID: 8},
			216: {CoreID: 24, SocketID: 0, NUMANodeID: 0, UnCoreCacheID: 2},
			217: {CoreID: 25, SocketID: 0, NUMANodeID: 0, UnCoreCacheID: 2},
			218: {CoreID: 26, SocketID: 0, NUMANodeID: 0, UnCoreCacheID: 2},
			219: {CoreID: 27, SocketID: 0, NUMANodeID: 0, UnCoreCacheID: 2},
			220: {CoreID: 28, SocketID: 0, NUMANodeID: 0, UnCoreCacheID: 2},
			221: {CoreID: 29, SocketID: 0, NUMANodeID: 0, UnCoreCacheID: 2},
			222: {CoreID: 30, SocketID: 0, NUMANodeID: 0, UnCoreCacheID: 2},
			223: {CoreID: 31, SocketID: 0, NUMANodeID: 0, UnCoreCacheID: 2},
			224: {CoreID: 32, SocketID: 0, NUMANodeID: 0, UnCoreCacheID: 6},
			225: {CoreID: 33, SocketID: 0, NUMANodeID: 0, UnCoreCacheID: 6},
			226: {CoreID: 34, SocketID: 0, NUMANodeID: 0, UnCoreCacheID: 6},
			227: {CoreID: 35, SocketID: 0, NUMANodeID: 0, UnCoreCacheID: 6},
			228: {CoreID: 36, SocketID: 0, NUMANodeID: 0, UnCoreCacheID: 6},
			229: {CoreID: 37, SocketID: 0, NUMANodeID: 0, UnCoreCacheID: 6},
			230: {CoreID: 38, SocketID: 0, NUMANodeID: 0, UnCoreCacheID: 6},
			231: {CoreID: 39, SocketID: 0, NUMANodeID: 0, UnCoreCacheID: 6},
			232: {CoreID: 40, SocketID: 0, NUMANodeID: 0, UnCoreCacheID: 10},
			233: {CoreID: 41, SocketID: 0, NUMANodeID: 0, UnCoreCacheID: 10},
			234: {CoreID: 42, SocketID: 0, NUMANodeID: 0, UnCoreCacheID: 10},
			235: {CoreID: 43, SocketID: 0, NUMANodeID: 0, UnCoreCacheID: 10},
			236: {CoreID: 44, SocketID: 0, NUMANodeID: 0, UnCoreCacheID: 10},
			237: {CoreID: 45, SocketID: 0, NUMANodeID: 0, UnCoreCacheID: 10},
			238: {CoreID: 46, SocketID: 0, NUMANodeID: 0, UnCoreCacheID: 10},
			239: {CoreID: 47, SocketID: 0, NUMANodeID: 0, UnCoreCacheID: 10},
			240: {CoreID: 48, SocketID: 0, NUMANodeID: 0, UnCoreCacheID: 3},
			241: {CoreID: 49, SocketID: 0, NUMANodeID: 0, UnCoreCacheID: 3},
			242: {CoreID: 50, SocketID: 0, NUMANodeID: 0, UnCoreCacheID: 3},
			243: {CoreID: 51, SocketID: 0, NUMANodeID: 0, UnCoreCacheID: 3},
			244: {CoreID: 52, SocketID: 0, NUMANodeID: 0, UnCoreCacheID: 3},
			245: {CoreID: 53, SocketID: 0, NUMANodeID: 0, UnCoreCacheID: 3},
			246: {CoreID: 54, SocketID: 0, NUMANodeID: 0, UnCoreCacheID: 3},
			247: {CoreID: 55, SocketID: 0, NUMANodeID: 0, UnCoreCacheID: 3},
			248: {CoreID: 56, SocketID: 0, NUMANodeID: 0, UnCoreCacheID: 7},
			249: {CoreID: 57, SocketID: 0, NUMANodeID: 0, UnCoreCacheID: 7},
			250: {CoreID: 58, SocketID: 0, NUMANodeID: 0, UnCoreCacheID: 7},
			251: {CoreID: 59, SocketID: 0, NUMANodeID: 0, UnCoreCacheID: 7},
			252: {CoreID: 60, SocketID: 0, NUMANodeID: 0, UnCoreCacheID: 7},
			253: {CoreID: 61, SocketID: 0, NUMANodeID: 0, UnCoreCacheID: 7},
			254: {CoreID: 62, SocketID: 0, NUMANodeID: 0, UnCoreCacheID: 7},
			255: {CoreID: 63, SocketID: 0, NUMANodeID: 0, UnCoreCacheID: 7},
			256: {CoreID: 64, SocketID: 0, NUMANodeID: 0, UnCoreCacheID: 11},
			257: {CoreID: 65, SocketID: 0, NUMANodeID: 0, UnCoreCacheID: 11},
			258: {CoreID: 66, SocketID: 0, NUMANodeID: 0, UnCoreCacheID: 11},
			259: {CoreID: 67, SocketID: 0, NUMANodeID: 0, UnCoreCacheID: 11},
			260: {CoreID: 68, SocketID: 0, NUMANodeID: 0, UnCoreCacheID: 11},
			261: {CoreID: 69, SocketID: 0, NUMANodeID: 0, UnCoreCacheID: 11},
			262: {CoreID: 70, SocketID: 0, NUMANodeID: 0, UnCoreCacheID: 11},
			263: {CoreID: 71, SocketID: 0, NUMANodeID: 0, UnCoreCacheID: 11},
			264: {CoreID: 72, SocketID: 0, NUMANodeID: 0, UnCoreCacheID: 1},
			265: {CoreID: 73, SocketID: 0, NUMANodeID: 0, UnCoreCacheID: 1},
			266: {CoreID: 74, SocketID: 0, NUMANodeID: 0, UnCoreCacheID: 1},
			267: {CoreID: 75, SocketID: 0, NUMANodeID: 0, UnCoreCacheID: 1},
			268: {CoreID: 76, SocketID: 0, NUMANodeID: 0, UnCoreCacheID: 1},
			269: {CoreID: 77, SocketID: 0, NUMANodeID: 0, UnCoreCacheID: 1},
			270: {CoreID: 78, SocketID: 0, NUMANodeID: 0, UnCoreCacheID: 1},
			271: {CoreID: 79, SocketID: 0, NUMANodeID: 0, UnCoreCacheID: 1},
			272: {CoreID: 80, SocketID: 0, NUMANodeID: 0, UnCoreCacheID: 5},
			273: {CoreID: 81, SocketID: 0, NUMANodeID: 0, UnCoreCacheID: 5},
			274: {CoreID: 82, SocketID: 0, NUMANodeID: 0, UnCoreCacheID: 5},
			275: {CoreID: 83, SocketID: 0, NUMANodeID: 0, UnCoreCacheID: 5},
			276: {CoreID: 84, SocketID: 0, NUMANodeID: 0, UnCoreCacheID: 5},
			277: {CoreID: 85, SocketID: 0, NUMANodeID: 0, UnCoreCacheID: 5},
			278: {CoreID: 86, SocketID: 0, NUMANodeID: 0, UnCoreCacheID: 5},
			279: {CoreID: 87, SocketID: 0, NUMANodeID: 0, UnCoreCacheID: 5},
			280: {CoreID: 88, SocketID: 0, NUMANodeID: 0, UnCoreCacheID: 9},
			281: {CoreID: 89, SocketID: 0, NUMANodeID: 0, UnCoreCacheID: 9},
			282: {CoreID: 90, SocketID: 0, NUMANodeID: 0, UnCoreCacheID: 9},
			283: {CoreID: 91, SocketID: 0, NUMANodeID: 0, UnCoreCacheID: 9},
			284: {CoreID: 92, SocketID: 0, NUMANodeID: 0, UnCoreCacheID: 9},
			285: {CoreID: 93, SocketID: 0, NUMANodeID: 0, UnCoreCacheID: 9},
			286: {CoreID: 94, SocketID: 0, NUMANodeID: 0, UnCoreCacheID: 9},
			287: {CoreID: 95, SocketID: 0, NUMANodeID: 0, UnCoreCacheID: 9},
			288: {CoreID: 96, SocketID: 1, NUMANodeID: 1, UnCoreCacheID: 16},
			289: {CoreID: 97, SocketID: 1, NUMANodeID: 1, UnCoreCacheID: 16},
			290: {CoreID: 98, SocketID: 1, NUMANodeID: 1, UnCoreCacheID: 16},
			291: {CoreID: 99, SocketID: 1, NUMANodeID: 1, UnCoreCacheID: 16},
			292: {CoreID: 100, SocketID: 1, NUMANodeID: 1, UnCoreCacheID: 16},
			293: {CoreID: 101, SocketID: 1, NUMANodeID: 1, UnCoreCacheID: 16},
			294: {CoreID: 102, SocketID: 1, NUMANodeID: 1, UnCoreCacheID: 16},
			295: {CoreID: 103, SocketID: 1, NUMANodeID: 1, UnCoreCacheID: 16},
			296: {CoreID: 104, SocketID: 1, NUMANodeID: 1, UnCoreCacheID: 20},
			297: {CoreID: 105, SocketID: 1, NUMANodeID: 1, UnCoreCacheID: 20},
			298: {CoreID: 106, SocketID: 1, NUMANodeID: 1, UnCoreCacheID: 20},
			299: {CoreID: 107, SocketID: 1, NUMANodeID: 1, UnCoreCacheID: 20},
			300: {CoreID: 108, SocketID: 1, NUMANodeID: 1, UnCoreCacheID: 20},
			301: {CoreID: 109, SocketID: 1, NUMANodeID: 1, UnCoreCacheID: 20},
			302: {CoreID: 110, SocketID: 1, NUMANodeID: 1, UnCoreCacheID: 20},
			303: {CoreID: 111, SocketID: 1, NUMANodeID: 1, UnCoreCacheID: 20},
			304: {CoreID: 112, SocketID: 1, NUMANodeID: 1, UnCoreCacheID: 24},
			305: {CoreID: 113, SocketID: 1, NUMANodeID: 1, UnCoreCacheID: 24},
			306: {CoreID: 114, SocketID: 1, NUMANodeID: 1, UnCoreCacheID: 24},
			307: {CoreID: 115, SocketID: 1, NUMANodeID: 1, UnCoreCacheID: 24},
			308: {CoreID: 116, SocketID: 1, NUMANodeID: 1, UnCoreCacheID: 24},
			309: {CoreID: 117, SocketID: 1, NUMANodeID: 1, UnCoreCacheID: 24},
			310: {CoreID: 118, SocketID: 1, NUMANodeID: 1, UnCoreCacheID: 24},
			311: {CoreID: 119, SocketID: 1, NUMANodeID: 1, UnCoreCacheID: 24},
			312: {CoreID: 120, SocketID: 1, NUMANodeID: 1, UnCoreCacheID: 18},
			313: {CoreID: 121, SocketID: 1, NUMANodeID: 1, UnCoreCacheID: 18},
			314: {CoreID: 122, SocketID: 1, NUMANodeID: 1, UnCoreCacheID: 18},
			315: {CoreID: 123, SocketID: 1, NUMANodeID: 1, UnCoreCacheID: 18},
			316: {CoreID: 124, SocketID: 1, NUMANodeID: 1, UnCoreCacheID: 18},
			317: {CoreID: 125, SocketID: 1, NUMANodeID: 1, UnCoreCacheID: 18},
			318: {CoreID: 126, SocketID: 1, NUMANodeID: 1, UnCoreCacheID: 18},
			319: {CoreID: 127, SocketID: 1, NUMANodeID: 1, UnCoreCacheID: 18},
			320: {CoreID: 128, SocketID: 1, NUMANodeID: 1, UnCoreCacheID: 22},
			321: {CoreID: 129, SocketID: 1, NUMANodeID: 1, UnCoreCacheID: 22},
			322: {CoreID: 130, SocketID: 1, NUMANodeID: 1, UnCoreCacheID: 22},
			323: {CoreID: 131, SocketID: 1, NUMANodeID: 1, UnCoreCacheID: 22},
			324: {CoreID: 132, SocketID: 1, NUMANodeID: 1, UnCoreCacheID: 22},
			325: {CoreID: 133, SocketID: 1, NUMANodeID: 1, UnCoreCacheID: 22},
			326: {CoreID: 134, SocketID: 1, NUMANodeID: 1, UnCoreCacheID: 22},
			327: {CoreID: 135, SocketID: 1, NUMANodeID: 1, UnCoreCacheID: 22},
			328: {CoreID: 136, SocketID: 1, NUMANodeID: 1, UnCoreCacheID: 26},
			329: {CoreID: 137, SocketID: 1, NUMANodeID: 1, UnCoreCacheID: 26},
			330: {CoreID: 138, SocketID: 1, NUMANodeID: 1, UnCoreCacheID: 26},
			331: {CoreID: 139, SocketID: 1, NUMANodeID: 1, UnCoreCacheID: 26},
			332: {CoreID: 140, SocketID: 1, NUMANodeID: 1, UnCoreCacheID: 26},
			333: {CoreID: 141, SocketID: 1, NUMANodeID: 1, UnCoreCacheID: 26},
			334: {CoreID: 142, SocketID: 1, NUMANodeID: 1, UnCoreCacheID: 26},
			335: {CoreID: 143, SocketID: 1, NUMANodeID: 1, UnCoreCacheID: 26},
			336: {CoreID: 144, SocketID: 1, NUMANodeID: 1, UnCoreCacheID: 19},
			337: {CoreID: 145, SocketID: 1, NUMANodeID: 1, UnCoreCacheID: 19},
			338: {CoreID: 146, SocketID: 1, NUMANodeID: 1, UnCoreCacheID: 19},
			339: {CoreID: 147, SocketID: 1, NUMANodeID: 1, UnCoreCacheID: 19},
			340: {CoreID: 148, SocketID: 1, NUMANodeID: 1, UnCoreCacheID: 19},
			341: {CoreID: 149, SocketID: 1, NUMANodeID: 1, UnCoreCacheID: 19},
			342: {CoreID: 150, SocketID: 1, NUMANodeID: 1, UnCoreCacheID: 19},
			343: {CoreID: 151, SocketID: 1, NUMANodeID: 1, UnCoreCacheID: 19},
			344: {CoreID: 152, SocketID: 1, NUMANodeID: 1, UnCoreCacheID: 23},
			345: {CoreID: 153, SocketID: 1, NUMANodeID: 1, UnCoreCacheID: 23},
			346: {CoreID: 154, SocketID: 1, NUMANodeID: 1, UnCoreCacheID: 23},
			347: {CoreID: 155, SocketID: 1, NUMANodeID: 1, UnCoreCacheID: 23},
			348: {CoreID: 156, SocketID: 1, NUMANodeID: 1, UnCoreCacheID: 23},
			349: {CoreID: 157, SocketID: 1, NUMANodeID: 1, UnCoreCacheID: 23},
			350: {CoreID: 158, SocketID: 1, NUMANodeID: 1, UnCoreCacheID: 23},
			351: {CoreID: 159, SocketID: 1, NUMANodeID: 1, UnCoreCacheID: 23},
			352: {CoreID: 160, SocketID: 1, NUMANodeID: 1, UnCoreCacheID: 27},
			353: {CoreID: 161, SocketID: 1, NUMANodeID: 1, UnCoreCacheID: 27},
			354: {CoreID: 162, SocketID: 1, NUMANodeID: 1, UnCoreCacheID: 27},
			355: {CoreID: 163, SocketID: 1, NUMANodeID: 1, UnCoreCacheID: 27},
			356: {CoreID: 164, SocketID: 1, NUMANodeID: 1, UnCoreCacheID: 27},
			357: {CoreID: 165, SocketID: 1, NUMANodeID: 1, UnCoreCacheID: 27},
			358: {CoreID: 166, SocketID: 1, NUMANodeID: 1, UnCoreCacheID: 27},
			359: {CoreID: 167, SocketID: 1, NUMANodeID: 1, UnCoreCacheID: 27},
			360: {CoreID: 168, SocketID: 1, NUMANodeID: 1, UnCoreCacheID: 17},
			361: {CoreID: 169, SocketID: 1, NUMANodeID: 1, UnCoreCacheID: 17},
			362: {CoreID: 170, SocketID: 1, NUMANodeID: 1, UnCoreCacheID: 17},
			363: {CoreID: 171, SocketID: 1, NUMANodeID: 1, UnCoreCacheID: 17},
			364: {CoreID: 172, SocketID: 1, NUMANodeID: 1, UnCoreCacheID: 17},
			365: {CoreID: 173, SocketID: 1, NUMANodeID: 1, UnCoreCacheID: 17},
			366: {CoreID: 174, SocketID: 1, NUMANodeID: 1, UnCoreCacheID: 17},
			367: {CoreID: 175, SocketID: 1, NUMANodeID: 1, UnCoreCacheID: 17},
			368: {CoreID: 176, SocketID: 1, NUMANodeID: 1, UnCoreCacheID: 21},
			369: {CoreID: 177, SocketID: 1, NUMANodeID: 1, UnCoreCacheID: 21},
			370: {CoreID: 178, SocketID: 1, NUMANodeID: 1, UnCoreCacheID: 21},
			371: {CoreID: 179, SocketID: 1, NUMANodeID: 1, UnCoreCacheID: 21},
			372: {CoreID: 180, SocketID: 1, NUMANodeID: 1, UnCoreCacheID: 21},
			373: {CoreID: 181, SocketID: 1, NUMANodeID: 1, UnCoreCacheID: 21},
			374: {CoreID: 182, SocketID: 1, NUMANodeID: 1, UnCoreCacheID: 21},
			375: {CoreID: 183, SocketID: 1, NUMANodeID: 1, UnCoreCacheID: 21},
			376: {CoreID: 184, SocketID: 1, NUMANodeID: 1, UnCoreCacheID: 25},
			377: {CoreID: 185, SocketID: 1, NUMANodeID: 1, UnCoreCacheID: 25},
			378: {CoreID: 186, SocketID: 1, NUMANodeID: 1, UnCoreCacheID: 25},
			379: {CoreID: 187, SocketID: 1, NUMANodeID: 1, UnCoreCacheID: 25},
			380: {CoreID: 188, SocketID: 1, NUMANodeID: 1, UnCoreCacheID: 25},
			381: {CoreID: 189, SocketID: 1, NUMANodeID: 1, UnCoreCacheID: 25},
			382: {CoreID: 190, SocketID: 1, NUMANodeID: 1, UnCoreCacheID: 25},
			383: {CoreID: 191, SocketID: 1, NUMANodeID: 1, UnCoreCacheID: 25},
		},
	}
)
