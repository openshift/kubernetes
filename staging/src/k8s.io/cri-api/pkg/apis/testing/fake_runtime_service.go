...
func (r *FakeRuntimeService) Status(ctx context.Context) (*runtimeapi.RuntimeStatus, error) {
	r.Lock()
	defer r.Unlock()
...
func (r *FakeRuntimeService) PodSandboxStatus(ctx context.Context, podSandboxID string) (*runtimeapi.PodSandboxStatus, error) {
	r.Lock()
	defer r.Unlock()
...
func (r *FakeRuntimeService) ContainerStatus(ctx context.Context, containerID string) (*runtimeapi.ContainerStatus, error) {
	r.Lock()
	defer r.Unlock()
