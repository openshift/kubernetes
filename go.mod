...
require (
	...
	github.com/openshift/api v0.0.0-20240701092931-d3b3bb16a382
...
replace (
	github.com/onsi/ginkgo/v2 => github.com/soltysh/ginkgo/v2 v2.1.5-0.20240628145812-f0248bc20762
