...
require (
	...
	github.com/openshift-eng/openshift-tests-extension v0.0.0-20250731200409-5415620cd78c
	github.com/openshift/api v0.0.0-20250729042826-6bd2705927ce
	github.com/openshift/apiserver-library-go v0.0.0-20250730003030-4cbacf92cdca
	github.com/openshift/client-go v0.0.0-20250729044348-b8b6d6a299ca
	github.com/openshift/library-go v0.0.0-20250730000442-e9ff9357275c
...
replace (
	...
	github.com/openshift/api => github.com/jacobsee/openshift-api v0.0.0-20250729042826-6bd2705927ce
	github.com/openshift/apiserver-library-go => github.com/jacobsee/apiserver-library-go v0.0.0-20250730003030-4cbacf92cdca
	github.com/openshift/client-go => github.com/jacobsee/client-go v0.0.0-20250729044348-b8b6d6a299ca
