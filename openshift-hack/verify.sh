...
# A rebase PR will fail this check due to the presence of upstream
# commits with summaries lacking the expected UPSTREAM: prefix. It
# will be up to the reviewer(s) to ensure that the this was the only
# validation failure before forcing merge of the rebase PR.
openshift-hack/verify-upstream-commits.sh || rc=1
