...
var map_AWSResourceTagSpec = map[string]string{
	...
	"value": "value is the value of the AWS tag. The value must consist only of alphanumeric and certain special characters(_.:/=+-@\\). value must be no more than 256 characters in length. Some AWS service do not support empty values. Since tags are added to resources in many services, the length of the tag value must meet the requirements of all services.",
}
