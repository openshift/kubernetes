...
var _ = SIGDescribe(framework.WithFeatureGate(features.ClusterTrustBundle), framework.WithFeatureGate(features.ClusterTrustBundleProjection), func() {
	...
	ginkgo.Context("CRUD Tests", func() {
		...
		*/
		ginkgo.It("certificates.k8s.io/v1 ClusterTrustBundles [MinimumKubeletVersion:1.37]", func(ctx context.Context) {
	...
	*/
	ginkgo.It("should be able to mount a single ClusterTrustBundle by name [MinimumKubeletVersion:1.37]", func(ctx context.Context) {
	...
	ginkgo.Describe("should be capable to mount multiple trust bundles by signer+labels", func() {
		...
		for _, tt := range []struct {
			...
			*/
			ginkgo.It(tt.name+" [MinimumKubeletVersion:1.37]", func(ctx context.Context) {
	...
	*/
	ginkgo.It("should be able to specify multiple CTB volumes [MinimumKubeletVersion:1.37]", func(ctx context.Context) {
	...
	*/
	ginkgo.It("should be able to mount a big number (>100) of CTBs [MinimumKubeletVersion:1.37]", func(ctx context.Context) {
		const numCTBs = 150
